...
import TicTacToeGame from './widgets/TicTacToeGame';
...
function App() {
 const [widgets, setWidgets] = useState([
  ...
  { id: new Date().getTime() + 3, component: <TicTacToeGame />, area: 'right-widget', name: "Weather" },
  { id: new Date().getTime() + 4, component: <StopwatchWidget />, area: 'left-widget', name: "Stopwatch" },
 ])
